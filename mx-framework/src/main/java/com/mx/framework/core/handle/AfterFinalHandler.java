...
import com.mx.framework.annotation.aop.AfterFinal;
 ...
 * @Date 2020/4/2
 */
public class AfterFinalHandler extends BaseHandler {

    public AfterFinalHandler() {
        handleAnnotations = new Class[]{AfterFinal.class};
    }
    ...
    public boolean doHandle(Class mainClass, Class handleClass, String[] args) throws Exception {
        ...
        List<Method> methods = ReflectionsUtil.getMethodsByAnnotation(handleClass,AfterFinal.class);

        for (Method method : methods){
            AfterFinal afterFinal = method.getAnnotation(AfterFinal.class);
            ...
            AopEvenMananger.registerEven(AopGroupEnum.AfterFinal,aopEven);
        }
