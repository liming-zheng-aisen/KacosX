...
import com.mx.framework.annotation.aop.Around;
...
public class AroundHandler extends BaseHandler {
    public AroundHandler() {
        handleAnnotations = new Class[]{Around.class};
    ...
    public boolean doHandle(Class mainClass, Class handleClass, String[] args) throws Exception {
        ...
        List<Method> methods = ReflectionsUtil.getMethodsByAnnotation(handleClass,Around.class);

        for (Method method : methods){
            Around afterFinal = method.getAnnotation(Around.class);
            ...
            AopEvenMananger.registerEven(AopGroupEnum.Around,aopEven);
        }
