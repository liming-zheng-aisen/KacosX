 ...
 * @Date 2019/9/13
 */
@DyWebServlet(url = "/druid/*")
public class DruidServlet extends DyResourceServlet {
    ...
    @DyValue("${dy.druid.userName}:dyboot")
    private String dyUserName="dyboot";

    @DyValue("${dy.druid.pwd}:123456")
    private String pwd="123456";

    private MBeanServerConnection conn = null;
    private DyServletConfig config2;

    @DyValue("${dy.druid.resetEnable}:true")
