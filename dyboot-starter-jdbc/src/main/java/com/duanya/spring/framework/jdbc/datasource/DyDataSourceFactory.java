...
public class DyDataSourceFactory {
    ...
    private static DySpringApplicationContext dySpringApplicationContext =new DySpringApplicationContext();
    public static final String PREFIX="dy.datasource.";
    public static final String DATA_SOURCE_TYPE="dy.datasource.type";
    public static boolean exist(){
        Object bean=null;
        try {
           bean= dySpringApplicationContext.getBean(DATA_SOURCE_NAME);
                ...
                try {
                    ...
                    for (Field fd : fields) {
                        ...
                        if (StringUtils.isNotEmpty(value)) {
                            DyValueFactory.setField(fd, dataSource, value);
                        }
                    }
                    dySpringApplicationContext.setContextBean(DATA_SOURCE_NAME, dataSource);
                    log.info("数据源加载成功！");
                } catch (ClassNotFoundException e) {
                    //....
