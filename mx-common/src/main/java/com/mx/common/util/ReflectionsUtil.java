...
public class ReflectionsUtil {
    ...
    public static void setFieldValue(Object bean, Field field, Object value) throws IllegalAccessException {
     ...
     * @return
     */
    public static List<Method> getMethodsByAnnotation(Class target, Class annotation) {
     ...
     * @return
     */
    public static Parameter[] getMethodParams(Method method){
     ...
     * @return
     */
    public static Class getClassByParameter(Parameter parameter){
        return (Class)parameter.getParameterizedType();
    }
