package com.mx.framework.nacos.rest;
...
import com.mx.framework.nacos.balance.NacosBalanceSerivce;
import com.mx.framework.nacos.rest.constant.MediaTypeConst;
...
public class RestClient{
    ...
    private NacosBalanceSerivce nacosBalanceSerivce;


    public RestClient() {
    }

    public RestClient(NacosBalanceSerivce nacosBalanceSerivce) {
        this.nacosBalanceSerivce = nacosBalanceSerivce;
    }

    public NacosBalanceSerivce getNacosBalanceSerivce() {
        return nacosBalanceSerivce;
    }

    public void setNacosBalanceSerivce(NacosBalanceSerivce nacosBalanceSerivce) {
        this.nacosBalanceSerivce = nacosBalanceSerivce;
    }
